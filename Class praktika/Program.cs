...
//clasın içində biz yazmasaq belə boş bir construktor işləyir.ona görə gönderdiyimiz veri ödəmirsə,bu boş construktor işə düşür.


/*using Class_praktika;
book book = new("c#","kutaisi",DateTime.Now);//new içi boş olduğu üçün gedib clasın parametri olmayan methodunu götürdü.
